...
--
-- Table structure for table `despacho_producto`
--

DROP TABLE IF EXISTS `despacho_producto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `despacho_producto` (
  `fk_productoi` int(11) NOT NULL,
  `fk_despacho` int(11) NOT NULL,
  KEY `FK1y7mhte5eebg5fxf3r1fp0oww` (`fk_despacho`),
  KEY `FKq6dj61jifp7mnu5h9l3ctxnpy` (`fk_productoi`),
  CONSTRAINT `FK1y7mhte5eebg5fxf3r1fp0oww` FOREIGN KEY (`fk_despacho`) REFERENCES `productos` (`id_producto`),
  CONSTRAINT `FKq6dj61jifp7mnu5h9l3ctxnpy` FOREIGN KEY (`fk_productoi`) REFERENCES `despachos` (`id_despacho`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `despacho_producto`
--

LOCK TABLES `despacho_producto` WRITE;
/*!40000 ALTER TABLE `despacho_producto` DISABLE KEYS */;
/*!40000 ALTER TABLE `despacho_producto` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `productos` (
  ...
  KEY `FK6g8qe5cy84u7lvcakjrphe33e` (`fk_inventario`),
  ...
  CONSTRAINT `FK6g8qe5cy84u7lvcakjrphe33e` FOREIGN KEY (`fk_inventario`) REFERENCES `inventarios` (`id_inventario`),
...
CREATE TABLE `usuarios` (
  ...
  `apellidou` varchar(40) DEFAULT NULL,
  `contrasena` varchar(50) DEFAULT NULL,
  `documento` bigint(20) DEFAULT NULL,
  `emailu` varchar(80) DEFAULT NULL,
  `estado` varchar(14) DEFAULT NULL,
  `nombreu` varchar(40) DEFAULT NULL,
...
-- Dump completed on 2022-10-20 12:28:53
